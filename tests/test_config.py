...
def test_history_dir_and_file_when_base_dir_from_env(tmp_path, monkeypatch):
    ...
    config = CalculatorConfig()
    # Since base_dir comes from env and there's no test_history in that dir, history_dir should be under tmp_path/history
