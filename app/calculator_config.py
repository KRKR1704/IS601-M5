...
class CalculatorConfig:
    ...
    def __init__(
        ...
        # Track if a base_dir was explicitly provided so properties can prefer
        # base-dir-derived paths over environment overrides when appropriate
        self._base_dir_provided = base_dir is not None
    ...
    def log_dir(self) -> Path:
        ...
        """
        # If base_dir was explicitly provided, prefer its logs directory
        if self._base_dir_provided:
    ...
    def history_dir(self) -> Path:
        ...
        """
        # If base_dir was explicitly provided, prefer base_dir/history over env
        if self._base_dir_provided:
            return (self.base_dir / "history").resolve()
    ...
    def history_file(self) -> Path:
        ...
        """
        # If base_dir was explicitly provided, prefer base_dir/history/calculator_history.csv
        if self._base_dir_provided:
    ...
    def log_file(self) -> Path:
        ...
        """
        # If base_dir explicitly provided, use base_dir logs path
        if self._base_dir_provided:
